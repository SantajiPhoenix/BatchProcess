...
@Service
public class CreditControlArchiveFileImpl implements ArchiveFile{

	@Value("${creditcontrol.filePath}")
	private String fileDirecotry;	

	private static Logger logger = LoggerFactory.getLogger(CreditControlArchiveFileImpl.class);
	@Override
