...
public class MarketPointsProcess implements JobProcessor {
    ...
    public void read() {
        ...
        final List<Object[]> marketPointsInc2Merged = marketPointsRepository.getViewPointsPerContractMergedInc2();
        marketPointsInc1and2.addAll(marketPointsInc2Merged);
        marketPointsInc1and2Totaal = marketPointsRepository.getViewPointsPerContractMergedInc1();
        final List<Object[]> marketPointsInc2TotaalMerged = marketPointsRepository.getViewPointsPerContractMergedInc2();
        marketPointsInc1and2Totaal.addAll(marketPointsInc2TotaalMerged);
